...
export const motors = {
  BMW: [
    ...
    },
    {
      ...
      prices: [
        ...
        { days: "3 to 5", peak: "$359.00", shoulder: "$339.00" },
      ],
      specs: [
        {
          key: "Engine:",
    ...
    },
    {
      ...
      prices: [
        ...
        { days: "3 to 5", peak: "$299.00", shoulder: "$279.00" },
      ],
      specs: [
        {
          key: "Manufacturer",
    ...
    },
    {
      ...
      img1: img1BMWR1250RT,
      prices: [
        { days: "15 to 21", peak: "$339.00", shoulder: "$309.00" },
        { days: "6 to 14", peak: "$369.00", shoulder: "$339.00" },
        { days: "3 to 5", peak: "$399.00", shoulder: "$369.00" },
      ],
      specs: [
        {
          key: "Engine:",
    ...
    },
    {
      ...
      prices: [
        ...
        { days: "3 to 5", peak: "$259.00", shoulder: "$239.00" },
      ],
      specs: [
        {
          key: "Engine Type",
    ...
    },
    {
      ...
      prices: [
        ...
        { days: "3 to 5", peak: "$239.00", shoulder: "$219.00" },
      ],
      specs: [
        {
          key: "Engine Type",
  ...
  Honda: [
    ...
    },
    {
      ...
      prices: [
        { days: "15 to 21", peak: "$159.00", shoulder: "$139.00" },
        { days: "6 to 14", peak: "$179.00", shoulder: "$159.00" },
        { days: "3 to 5", peak: "$199.00", shoulder: "$179.00" },
      ],
      specs: [
        {
          key: "Engine Type",
  ...
  Triumph: [
    {
      ...
      prices: [
        ...
        { days: "3 to 5", peak: "$219.00", shoulder: "$199.00" },
      ],
      specs: [
        {
          key: "ENGINE",
